...
parser.add_argument('--dataset', default="reg",type=str, help="choose from  [sarcos  baseball cahouse ]")
...
def train_model():
    ...
    train_history, val_history,test_history = train(
        ...
        early_stopping_patience=early_stopping_patience, early_stopping_start_from=early_stopping_start_from, gpu_num=args.gpunum,save_model_path=save_model_path)
